...
{
    public abstract class ProDiegoV2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProDiegoV2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProDiegoV2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProDiegoV2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProDiegoV2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProDiegoV2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProDiegoV2DbContext, Task<T>> func)
        {
            T result;
